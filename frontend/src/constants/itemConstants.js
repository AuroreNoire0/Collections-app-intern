...
export const ITEM_CREATE_CLEAN = "ITEM_CREATE_CLEAN";
...
export const ITEM_UPDATE_CLEAN = "ITEM_UPDATE_CLEAN";
...
export const ITEM_TAGS_LIST_SUCCESS = "ITEM_TAGS_LIST_SUCCESS";
export const ITEM_TAGS_LIST_REQUEST = "ITEM_TAGS_LIST_REQUEST";
export const ITEM_TAGS_LIST_FAIL = "ITEM_TAGS_LIST_FAIL";
